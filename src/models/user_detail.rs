...
pub struct UserDetail {
    ...
    #[serde(rename = "curatorTab", skip_serializing_if = "Option::is_none")]
    ...
    pub follow_data: Option<Box<models::UserFollowData>>,
    ...
    #[serde(rename = "seniorCurator", skip_serializing_if = "Option::is_none")]
    pub senior_curator: Option<bool>,
    #[serde(rename = "stats", skip_serializing_if = "Option::is_none")]
    pub stats: Option<Box<models::UserStats>>,
...
pub enum Patreon {
    ...
    Supporter,
    #[serde(rename = "SupporterPlus")]
    SupporterPlus,
}

impl Default for Patreon {
    fn default() -> Patreon {
        Self::None
    }
}
