...
pub async fn maps_hash_hash_get(
    ...
    hash: &str,
) -> Result<crate::models::MapDetail, Error<MapsHashHashGetError>> {
...
pub async fn maps_id_id_get(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<crate::models::MapDetail, Error<MapsIdIdGetError>> {
    let local_var_configuration = configuration;
...
pub async fn maps_latest_get(
    ...
    sort: Option<&str>,
) -> Result<crate::models::SearchResponse, Error<MapsLatestGetError>> {
    let local_var_configuration = configuration;
...
pub async fn maps_plays_page_get(
    configuration: &configuration::Configuration,
    page: i64,
) -> Result<crate::models::SearchResponse, Error<MapsPlaysPageGetError>> {
    let local_var_configuration = configuration;
...
pub async fn maps_uploader_id_page_get(
    ...
    id: i32,
    page: i64,
) -> Result<crate::models::SearchResponse, Error<MapsUploaderIdPageGetError>> {
    let local_var_configuration = configuration;
...
pub async fn playlists_id_id_batch_post(
    configuration: &configuration::Configuration,
    id: i32,
    no_reflection_body: crate::models::PlaylistBatchRequest,
) -> Result<crate::models::ActionResponse, Error<PlaylistsIdIdBatchPostError>> {
    let local_var_configuration = configuration;
...
pub async fn playlists_id_id_page_get(
    ...
    id: i32,
    page: i64,
) -> Result<crate::models::PlaylistPage, Error<PlaylistsIdIdPageGetError>> {
    let local_var_configuration = configuration;
...
pub async fn playlists_latest_get(
    ...
    before: Option<String>,
    sort: Option<&str>,
) -> Result<crate::models::PlaylistSearchResponse, Error<PlaylistsLatestGetError>> {
    let local_var_configuration = configuration;
...
pub async fn playlists_search_page_get(
    ...
    max_nps: Option<serde_json::Value>,
    min_nps: Option<serde_json::Value>,
    q: Option<&str>,
    to: Option<String>,
    verified: Option<bool>,
) -> Result<crate::models::PlaylistSearchResponse, Error<PlaylistsSearchPageGetError>> {
    let local_var_configuration = configuration;
...
pub async fn playlists_user_user_id_page_get(
    ...
    page: i64,
    user_id: i32,
) -> Result<crate::models::PlaylistSearchResponse, Error<PlaylistsUserUserIdPageGetError>> {
    let local_var_configuration = configuration;
...
pub async fn search_text_page_get(
    ...
    max_bpm: Option<serde_json::Value>,
    max_duration: Option<i32>,
    max_nps: Option<serde_json::Value>,
    max_rating: Option<serde_json::Value>,
    me: Option<bool>,
    min_bpm: Option<serde_json::Value>,
    min_duration: Option<i32>,
    min_nps: Option<serde_json::Value>,
    min_rating: Option<serde_json::Value>,
    noodle: Option<bool>,
    q: Option<&str>,
    ranked: Option<bool>,
    tags: Option<&str>,
    to: Option<String>,
    verified: Option<bool>,
) -> Result<crate::models::SearchResponse, Error<SearchTextPageGetError>> {
    let local_var_configuration = configuration;
...
pub async fn users_id_id_get(
    configuration: &configuration::Configuration,
    id: i32,
) -> Result<crate::models::UserDetail, Error<UsersIdIdGetError>> {
    let local_var_configuration = configuration;
...
pub async fn users_name_name_get(
    configuration: &configuration::Configuration,
    name: &str,
) -> Result<crate::models::UserDetail, Error<UsersNameNameGetError>> {
    let local_var_configuration = configuration;
...
pub async fn users_verify_post(
    configuration: &configuration::Configuration,
    no_reflection_body: crate::models::AuthRequest,
) -> Result<crate::models::VerifyResponse, Error<UsersVerifyPostError>> {
    let local_var_configuration = configuration;
...
pub async fn vote_get(
    configuration: &configuration::Configuration,
    since: String,
) -> Result<Vec<crate::models::VoteSummary>, Error<VoteGetError>> {
    let local_var_configuration = configuration;
...
pub async fn vote_post(
    configuration: &configuration::Configuration,
    no_reflection_body: crate::models::VoteRequest,
) -> Result<crate::models::VoteResponse, Error<VotePostError>> {
    let local_var_configuration = configuration;
