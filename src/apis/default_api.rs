...
pub async fn maps_latest_get(configuration: &configuration::Configuration, after: Option<String>, automapper: Option<bool>, before: Option<String>, sort: Option<&str>) -> Result<crate::models::SearchResponse, Error<MapsLatestGetError>> {
    let local_var_configuration = configuration;
...
pub async fn playlists_id_id_batch_post(configuration: &configuration::Configuration, id: i32, no_reflection_body: crate::models::PlaylistBatchRequest) -> Result<crate::models::ActionResponse, Error<PlaylistsIdIdBatchPostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/playlists/id/{id}/batch", local_var_configuration.base_path, id=id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PlaylistsIdIdBatchPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn playlists_id_id_page_get(configuration: &configuration::Configuration, id: i32, page: i64) -> Result<crate::models::PlaylistPage, Error<PlaylistsIdIdPageGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/playlists/id/{id}/{page}", local_var_configuration.base_path, id=id, page=page);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PlaylistsIdIdPageGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn playlists_latest_get(configuration: &configuration::Configuration, after: Option<String>, before: Option<String>, sort: Option<&str>) -> Result<crate::models::PlaylistSearchResponse, Error<PlaylistsLatestGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PlaylistsLatestGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn playlists_search_page_get(configuration: &configuration::Configuration, page: i64, sort_order: &str, curated: Option<bool>, from: Option<String>, include_empty: Option<bool>, max_nps: Option<serde_json::Value>, min_nps: Option<serde_json::Value>, q: Option<&str>, to: Option<String>, verified: Option<bool>) -> Result<crate::models::PlaylistSearchResponse, Error<PlaylistsSearchPageGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/playlists/search/{page}", local_var_configuration.base_path, page=page);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_str) = include_empty {
        local_var_req_builder = local_var_req_builder.query(&[("includeEmpty", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PlaylistsSearchPageGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn playlists_user_user_id_page_get(configuration: &configuration::Configuration, page: i64, user_id: i32) -> Result<crate::models::PlaylistSearchResponse, Error<PlaylistsUserUserIdPageGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/playlists/user/{userId}/{page}", local_var_configuration.base_path, page=page, userId=user_id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn vote_get(configuration: &configuration::Configuration, since: String) -> Result<Vec<crate::models::VoteSummary>, Error<VoteGetError>> {
    let local_var_configuration = configuration;
